...
class UserStars extends React.Component {
  ...
  //   } else {
  //     this.props.action({"rating": this.props.rating, "recipeId": this.props.recipeId, id: this.props.currentRatingId});
  //   }
  // }
  ...
  render() {
    ...
    return (
      ...
      <li className={this.state.className} val={this.props.val}
        onMouseEnter={this.handleHover} onMouseLeave={this.removeHover} onClick={this.props.action}>
      </li>
    </div>
    );
  }
